...
import AsideEnterprise from "./AsideEnterprise";
    ...
    >
      ...
      >
        <div className="flex h-full flex-col justify-between ">
          <div className="">
            <AsideEnterprise></AsideEnterprise>
            ...
            <Sidebar.Items>
              <Sidebar.ItemGroup>
                <Link to="/" className="flex items-center gap-[12px] rounded-lg p-2 text-base font-medium text-gray-900 hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">
                    <HiChartPie className="h-6 w-6 shrink-0 text-gray-500 transition duration-75 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white" />
                    Dashboard
                </Link>
                <Link to="/ambientes" className="flex items-center gap-[12px] rounded-lg p-2 text-base font-medium text-gray-900 hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">
                  <HiViewGrid className="h-6 w-6 shrink-0 text-gray-500 transition duration-75 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white"></HiViewGrid>
                  Ambientes
                </Link>

                <Link to="/contato" className="flex items-center gap-[12px] rounded-lg p-2 text-base font-medium text-gray-900 hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">
                  
                  <HiUserGroup className="h-6 w-6 shrink-0 text-gray-500 transition duration-75 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white" />
                  Contatos
                </Link>

                <Link to="/configuracao" className="flex items-center gap-[12px] rounded-lg p-2 text-base font-medium text-gray-900 hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">
                  
                  <FaGear className="h-6 w-6 shrink-0 text-gray-500 transition duration-75 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white" />
                  Configurações
                </Link>
